...
class Hookean_Always(FixConstraint):
    """Always applies a Hookean restorative force between a pair of atoms, an atom
    and a point, or an atom and a plane."""

    def __init__(self, a1, a2, k, rt=None):
        """Forces two atoms to stay close together by applying a Hookean
        restorative force depending on the value of rt (threshold length). 
        Can also be used to tether an atom to a fixed point in space or 
        to a distance above a plane.
        ...
        k : float
           ...
           exceeds threshold_length.
        rt : float
           The maximum bond length. Hookean will be applied until this length 
           is reached. The length is 1) between two atoms, 2) between atom and 
           point. This argument is not supplied in case 3.
