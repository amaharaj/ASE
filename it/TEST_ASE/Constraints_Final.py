...
atoms = read('17.5_degrees.xyz')

atoms.set_calculator(Dftb(label = '17.5_degrees.xyz',
                         atoms=atoms,
...
for a in array2:
	D = atoms.positions[a][0] - 3.0
	c2 = Hookean(a1=a, a2=(D, 0, 0), rt = D,  k=10.0)
